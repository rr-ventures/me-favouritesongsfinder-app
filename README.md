...
See [`mixingsongfinder_build_plan_bd05c0ad.plan.md`](mixingsongfinder_build_plan_bd05c0ad.plan.md) for the full phased build plan (architecture decisions, file-by-file order, mock data spec, risk register, acceptance criteria).
